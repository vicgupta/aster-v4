...
class OllamaModel:
    ...
    def ask(
        ...
        self._total_input_tokens = res["prompt_eval_count"] + self._input_tokens
        self._total_output_tokens = res["eval_count"] + self._output_tokens
        self._input_tokens = res["prompt_eval_count"]
        self._output_tokens = res["eval_count"]
